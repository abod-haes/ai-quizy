...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card text-card-foreground relative flex flex-col gap-4 overflow-hidden rounded-2xl border border-border py-5 shadow-sm transition-all duration-200 hover:border-primary/15 hover:shadow-md",
        className,
      )}
      {...props}
    />
